...
(()=>{
  ...
  function addScript(src,onload){if(document.querySelector(`script[src^="${src}"]`)){onload?.();return}const s=document.createElement('script');s.src=src+'?v=93';if(onload)s.onload=onload;document.body.appendChild(s)}
