// ShelfCheck Art Department PREVIEW ONLY. Same-origin preview UI, not loaded by live index.
(()=>{
  const titleCovers={
  ...
  window.SHELFCHECK_COVER_ART={version:101,preview:true,paint,repaint,coverFor,productCover,openLightbox};
