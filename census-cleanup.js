...
(()=>{
  const EXCLUDE=new Map([
    ...
    ['rush vr','PSVR and PS Camera required on PS4; official PlayStation Store listing confirms headset required.'],
    ['the playroom vr','PSVR and PS Camera required on PS4; official PlayStation Store listing confirms both are required.'],
  ...
  const KEEP=new Map([
    ...
    ['the assembly','PSVR features exist, but official PlayStation listing labels VR/Camera as compatible rather than required; do not exclude as VR-only without stronger evidence.'],
