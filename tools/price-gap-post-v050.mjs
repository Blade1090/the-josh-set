...
console.log(JSON.stringify({canonicalRuntimeLive:report.canonicalRuntimeLive,priced:report.priced,missing:report.missing,productOrCompilation:report.productOrCompilation,noSafeIdentityPrice:report.noSafeIdentityPrice,v050Recovered:report.v050Recovered},null,2));
